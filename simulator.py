...
class MR_cost_model:
    ...
    def get_mr_cost(self, data_input_mb, data_interm_mb, sort_correction_enabled=False, reduce_in_memory=True, ):
        """
        ...
        print "map merge cost: ", map_merge_cost
        ...
        print "red overhead cost: ", red_overhead_cost
        print "red merge cost: ", red_merge_cost
        print "red sort cost: ", red_sort_cost

        total_map = map_in_read_cost + map_out_initial_write_cost + map_merge_cost
        total_red = red_in_read_cost + red_merge_cost + red_overhead_cost
